...
recshard1: go run cmd/shard/shard.go -rec -parentIpAddr localhost:4000 -ipAddr localhost:6000 -storagePath tmp/shard1 -interval 10s
recshard2: go run cmd/shard/shard.go -rec -parentIpAddr localhost:4000 -ipAddr localhost:6001 -storagePath tmp/shard2 -interval 1s
