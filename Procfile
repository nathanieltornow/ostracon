...
recshard1: go run cmd/rshard/rshard.go -parentIpAddr localhost:4002 -ipAddr localhost:6000
recshard2: go run cmd/rshard/rshard.go -parentIpAddr localhost:4002 -ipAddr localhost:6001
recshard3: go run cmd/rshard/rshard.go -parentIpAddr localhost:4002 -ipAddr localhost:6002
